	...
	<%@ page import="com.proyPetStore.beans.Mascota" %>
		<%@ page import="java.util.List" %>
			<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
				...
				<% String url=request.getContextPath() + "/" ; Historial_Medico historial=(Historial_Medico)
					request.getAttribute("historial"); List<Mascota> listaMascotas = (List<Mascota>)
											...
											<% } %>
												...
												<div class="mb-3">
													<label for="id_mascota" class="form-label">Mascota:</label> <select
														...
														<% if (listaMascotas !=null) { for (Mascota m : listaMascotas) {
															String
															selected=(historial.getId_mascota()==m.getId_mascota())
															? "selected" : "" ; %>
												...
												<div class="mb-3">
													...
													<textarea name="descripcion" id="descripcion" class="form-control"
														rows="4"
														required><%=historial.getDescripcion() != null ? historial.getDescripcion() : ""%></textarea>
												</div>

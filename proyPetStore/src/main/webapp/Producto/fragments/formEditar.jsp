    ...
    <%@page import="java.util.List" %>
        <%@page import="com.proyPetStore.beans.Producto" %>
            <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                ...
                <% String url=request.getContextPath() + "/" ; Producto producto=(Producto)
                    request.getAttribute("producto"); List<Categoria> listarCategoria = (List<Categoria>)
                                        ...
                                        <form action="<%=url%>ProductoController" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="stock" id="stock"
                                                    value="<%=producto.getStock()%>" class="form-control" min="0"
                                                    required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="precio_costo" id="precio_costo"
                                                    value="<%=producto.getPrecio_costo()%>" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="precio_venta" id="precio_venta"
                                                    value="<%=producto.getPrecio_venta()%>" class="form-control"
                                                    step="0.01" min="0" required>
                                            </div>

...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex justify-content-end mb-3">
            <button class="btn btn-success" onclick="modalProducto.abrir('nuevo')">➕ Nuevo Producto</button>
        </div>
    </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    <%
                    List<Producto> listarProducto = (List<Producto>) request.getAttribute("listarProducto");
                    ...
                    <tr>
                        ...
                        <td><%=p.getNombre()%></td>
                        <td><%=p.getNombreCat()%></td>
                        <td><%=p.getDescripcion()%></td>
                        <td><%=p.getStock()%></td>

                        <td>S/ <%=String.format("%.2f", p.getPrecio_costo())%></td>
                        <td>S/ <%=String.format("%.2f", p.getPrecio_venta())%></td>

                        <td>
                            <span class="badge <%= p.getEstado().equals("Activo") ? "bg-success" : "bg-secondary" %>">
                                <%=p.getEstado()%>
                            </span>
                        ...
                        <td class="acciones">
                            ...
                            <button onclick="modalProducto.abrir('editar', <%=p.getId_producto()%>)"
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
    <div id="toastMensaje" class="toast align-items-center text-bg-<%= mensaje.contains("Error") ? "danger" : "success" %> border-0" role="alert">
        <div class="d-flex">

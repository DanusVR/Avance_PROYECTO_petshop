...
<body class="bg-light">
	...
	<div class="container mt-5">
		...
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			<a href="<%=request.getContextPath()%>/VentaController?accion=nuevo"
				class="btn btn-success"> ➕ Nueva Venta </a>
		</div>
				...
				<table class="table table-striped table-hover align-middle">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=v.getFecha() != null ? v.getFecha() : "-"%></td>
							<td>$<%=String.format("%.2f", v.getTotal())%></td>
							<td><%=v.getTipo_pago() != null ? v.getTipo_pago() : "-"%></td>
							<td>
	...
	const modalReciboFunc = {
		    abrir: function(idVenta) {
		        let url = 'VentaController?accion=verRecibo&idVenta=' + idVenta;

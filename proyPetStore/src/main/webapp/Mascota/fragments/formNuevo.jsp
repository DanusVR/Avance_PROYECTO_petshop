...
<div class="container mt-4">
    ...
    <div class="card shadow-sm col-md-6 mx-auto">
        <div class="card-body">
            <form action="<%=request.getContextPath()%>/MascotaController?op=insertar" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="especie" required>
                        ...
                        <option value="Perro" <%= "Perro".equals(especieSeleccionada) ? "selected" : "" %>>Perro</option>
                        <option value="Gato" <%= "Gato".equals(especieSeleccionada) ? "selected" : "" %>>Gato</option>
                     </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="sexo" required>
                        ...
                        <option value="Macho" <%= "Macho".equals(sexoSeleccionado) ? "selected" : "" %>>Macho</option>
                        <option value="Hembra" <%= "Hembra".equals(sexoSeleccionado) ? "selected" : "" %>>Hembra</option>
                    </select>
                </div>
                    ...
                    <select name="id_cliente" class="form-select" required>
                        ...
                        if (listarCliente != null) {
                            for (Cliente cliente : listarCliente) {
                                String selected = (cliente.getId_cliente() == clienteSeleccionado) ? "selected" : "";
                        %>
                ...
                <button type="submit" class="btn btn-success w-100 mb-2">💾 Guardar Mascota</button>
            </form>

            <a href="<%=request.getContextPath()%>/MascotaController?op=listar" class="btn btn-primary w-100">← Volver a la lista</a>
        </div>
    </div>
</div>

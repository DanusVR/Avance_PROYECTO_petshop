...
public class MascotaController extends HttpServlet {
    ...
    throws ServletException,IOException {   
    		...
    		if(opc == null) {
                   listar(request, response);return;
    		}
    		 // Detectar si es AJAX
			...
			case "nuevo":				
				cargarFormularioNuevo(request, response);break;
			case "editar":
				cargarFormularioEditar(request, response);break;
			case "insertar":
			...
			case "modificar":
				...
				break;
			case "eliminar":
				this.eliminar(request, response);break;
			case "reporte":
